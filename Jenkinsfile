...
// for display purposes
      ...
      git 'https://github.com/venkatesh1252/hello-world-servlet.git'
...
post {
        success {
            mail to:"venky.usapp@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
            mail to:"venky.usapp@gmail.com", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
